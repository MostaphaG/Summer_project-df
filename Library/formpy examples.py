...
# Plotting vector fields using alternative figure and axis.
# Axis is now an input for the vector field object.
# To create subplots, the user must create them before then specify the parent figure and axis.
# Allows for more efficiency when plotting on inset axes.
...
zvf = vf1.zoom((2,1), 20, inset=True)
# zvf.plot()

# zvf2 = vf1.zoom((-2,1), 20, inset=True)
# zvf2.plot()
...
fig1 = plt.figure(figsize=(15,5))
ax1 = fig1.add_subplot(131)
ax1.set_xlabel('Vector field 1')
ax2 = fig1.add_subplot(132)
ax2.set_xlabel('Vector field 2 with derivative inset')
ax3 = fig1.add_subplot(133)
ax3.set_xlabel('Derivative field')

# Plot the vector field

vf1 = fp.vector_field(xg, yg, u, v, fig = fig1, ax = ax1)
vf1.plot()

# Plot another vector field

vf2 = fp.vector_field(xg, yg, u1, v1, fig = fig1, ax = ax2)
vf2.plot()
vf2.give_eqn('y','x')
...
vf2_DF_inset = vf2.DF((1,3), 20, 9, inset=True)
vf2_DF_inset.plot()
...
vf2_DF_newax = vf2.DF((1,3), 20, 9, fig=fig1, ax=ax3)
vf2_DF_newax.plot()
