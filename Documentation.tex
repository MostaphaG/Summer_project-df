...
A graphically clearer way of representing 2 forms is through the superposition of stacks from one forms. In this case, 2 forms are represented by squares, where




\subsection{2 forms on R2 from a wedge product}




\subsection{2 forms on R2 from the exterior derivative}
...
\subsection{Representing 1 forms on $\mathbb{R}^{3}$}
